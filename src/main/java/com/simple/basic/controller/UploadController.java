...
public class UploadController {
    ...
    public String uploadOk(@RequestParam("file") MultipartFile file) {
        ...
        //1. 브라우저 별 사용자의 풀경로가 제목에 포함되는 경우가 있음 (제외)
        //2. 동일한 파일에 대한 처리, 동일한 이름이 올라오면 파일이 덮어씌워집니다. (랜덤값 처리)
        //3. 1개의 폴더에 저장가능한 파일 수는 6만개 정도인데 (월별로 폴더를 생성해서 처리)
